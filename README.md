# `ZPares_jll.jl` (v0.1.0+0)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/4da6eefcc18699c862c8ca32771eb95093f76644/Z/ZPares/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.  If you have any issue, please report it to the Yggdrasil [bug tracker](https://github.com/JuliaPackaging/Yggdrasil/issues).

For more details about JLL packages and how to use them, see `BinaryBuilder.jl` [documentation](https://juliapackaging.github.io/BinaryBuilder.jl/dev/jll/).

## Sources

The tarballs for `ZPares_jll.jl` have been built from these sources:

* git repository: https://github.com/cometscome/zpares_mirror.git (revision: `1e84be7cd0f8368da09ac0c262f815583ce04b7d`)
* file: https://zpares.cs.tsukuba.ac.jp/?download=242 (SHA256 checksum: `3c34257d249451b0b984abc985e296ebb73ae5331025f1b8ea08d50301c7cf9a`)

## Platforms

`ZPares_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `ZPares_jll.jl`:
